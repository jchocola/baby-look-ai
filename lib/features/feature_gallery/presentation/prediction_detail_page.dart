    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          BigButton(title: 'View Full Image',borderColor: theme.colorScheme.primary,buttonColor: theme.colorScheme.onPrimary, icon: Icon(AppIcon.fullImageIcon),),
          BigButton(title: "Share Prediction", borderColor: theme.colorScheme.tertiary,buttonColor: theme.colorScheme.tertiaryFixed, icon: Icon(AppIcon.shareIcon),),
