    ...
    return Column(
      ...
      children: [
       ...
       cardColor: theme.colorScheme.tertiaryFixed,
          ...
          title: "Clear Profile View",
          subtitle: "Choose an image showing the baby's profile clearly",
        ),
        TipsCard(
          iconBgColor: theme.colorScheme.onPrimary,
          iconColor: theme.colorScheme.primary,
          ...
          title: "Good Lighting",
          subtitle: "Ensure the ultrasound image is well-lit and not blurry",
        ),
        TipsCard(
          iconBgColor: theme.colorScheme.onPrimary,
          iconColor: theme.colorScheme.primary,
          ...
          title: "Recent Scan",
          subtitle: "Use your most recent ultrasound for best accuracy",
        ),
      ],
    );
  }
