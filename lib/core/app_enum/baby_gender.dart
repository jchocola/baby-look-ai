...
String genderToStr(BuildContext context, {required String? gender}) {
   switch (gender) {
    case "BOY":
      return context.tr(AppText.boy);
    case "GIRL":
      return context.tr(AppText.girl);
    default:
      return context.tr(AppText.dont_know);
  }
}
